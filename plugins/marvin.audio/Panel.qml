...
// Marvin restyle. A clone of the built-in: every line of logic is
...
Panel {
  ...
  function ensureCursorVisible(item) {
    ...
    if (maxY <= Style.spacing.xxl || (root.focusSection === "output" && root.selectedIndex === -1)) {
      flick.contentY = 0
      return
    }
        ...
        Column {
          ...
          Item {
            ...
            Column {
              ...
              anchors.right: parent.right
              anchors.rightMargin: powerSwitch.width + Style.spacing.md
              anchors.verticalCenter: parent.verticalCenter
          ...
          Column {
            ...
            CursorSurface {
              ...
              PanelSlider {
                id: outputSlider
                bar: root.bar
                trackHeight: Style.spacing.xxs
                knobSize: Style.spacing.md
                trackColor: Style.normalFillFor(root.bar.foreground, Color.accent)
                anchors.fill: parent
  ...
  component SinkRow: CursorSurface {
    ...
    Row {
      ...
      Text {
        ...
        font.weight: sinkRow.isActive ? Font.Medium : Font.Normal
        elide: Text.ElideRight
        width: parent.width - Style.spacing.xxl - Style.spacing.sm
        anchors.verticalCenter: parent.verticalCenter
      }
    }
  ...
  component SourceRow: CursorSurface {
    ...
    Row {
      ...
      Text {
        ...
        font.family: root.bar.fontFamily
        font.pixelSize: Style.font.body
        font.weight: sourceRow.isActive ? Font.Medium : Font.Normal
        elide: Text.ElideRight
        width: parent.width - Style.spacing.xxl - Style.spacing.sm
        anchors.verticalCenter: parent.verticalCenter
      }
    ...
    Column {
      ...
      Row {
        ...
        Text {
          ...
          font.family: root.bar.fontFamily
          font.pixelSize: Style.font.body
          font.weight: streamRow.isActive ? Font.Medium : Font.Normal
          elide: Text.ElideRight
          width: parent.width - streamMuteIcon.width - streamPct.width - Style.spacing.lg
          anchors.verticalCenter: parent.verticalCenter
        }
        ...
        Text {
          ...
          font.pixelSize: Style.font.caption
          font.weight: Font.Medium
          width: Style.spacing.xxxl + Style.spacing.sm
