    ...
    Column {
      ...
      Item {
        ...
        Column {
          ...
          anchors.right: parent.right
          anchors.rightMargin: heroActions.width > 0 ? heroActions.width + Style.spacing.md : 0
          anchors.verticalCenter: parent.verticalCenter
  ...
  component NetworkRow: CursorSurface {
    ...
    Item {
      ...
      Column {
        ...
        anchors.rightMargin: rightAction.visible ? Style.spacing.sm : 0
        anchors.verticalCenter: parent.verticalCenter
    ...
    Item {
      ...
      implicitHeight: (idField.visible ? idField.implicitHeight + Style.spacing.xs : 0) + pwField.implicitHeight + Style.spacing.rowGap
