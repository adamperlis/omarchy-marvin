...
Panel {
  ...
  function heroMeta(p) {
    ...
    return tier.charAt(0) + tier.slice(1)
  }
  ...
  component Meter: Item {
    ...
    property real thickness: Math.max(Style.spacing.xs, Math.round(Style.spacing.controlHeight * 0.14))
  ...
  component DayRow: Item {
    ...
    Text {
      ...
      font.family: root.fontFamily
      font.pixelSize: Style.font.caption
      font.weight: dayRow.today ? Font.Medium : Font.Normal
      anchors.left: parent.left
      anchors.verticalCenter: parent.verticalCenter
    ...
    Rectangle {
      ...
      anchors.rightMargin: Style.spacing.sm
      anchors.verticalCenter: parent.verticalCenter
      height: Math.max(Style.spacing.xs, Math.round(Style.spacing.controlHeight * 0.14))
      radius: height / 2
      color: root.track
