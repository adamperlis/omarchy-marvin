  ...
  component AccountRow: CursorSurface {
    ...
    Row {
      ...
      Text {
        ...
        font.family: root.fontFamily
        font.pixelSize: Style.font.body
        font.weight: accountRow.selectedAccount ? Font.Medium : Font.Normal
        elide: Text.ElideRight
  ...
  component PeerRow: CursorSurface {
    ...
    RowLayout {
      ...
      Popup {
        ...
        y: copyButton.y + copyButton.height + Style.spacing.xs
  ...
  component ExitNodeRow: CursorSurface {
    ...
    Row {
      ...
      Text {
        ...
        font.family: root.fontFamily
        font.pixelSize: Style.font.body
        font.weight: exitNodeRow.activeExitNode ? Font.Medium : Font.Normal
        elide: Text.ElideRight
        width: parent.width - Style.spacing.xxl - Style.spacing.sm
        anchors.verticalCenter: parent.verticalCenter
      }
    ...
    Row {
      ...
      Column {
        ...
        Text {
          ...
          font.family: root.fontFamily
          font.pixelSize: Style.font.body
          font.weight: regionRow.activeExitNode ? Font.Medium : Font.Normal
          elide: Text.ElideRight
        }
