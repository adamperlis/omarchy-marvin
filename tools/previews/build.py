...
ICONS = {
 ...
 "trash": '<path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"/>', "lock": '<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/><circle cx="12" cy="16" r="1.2" fill="currentColor" stroke="none"/>', "download": '<path d="M12 4v12M7 11l5 5 5-5M4 20h16"/>',
}
...
.card .pills em{font-style:normal;height:40px;padding:0 20px;border-radius:20px;display:flex;align-items:center;gap:8px;background:rgba(var(--fg-rgb),.06);white-space:nowrap}.card .pills em.on{background:rgba(var(--fg-rgb),.14)}
...
.card .mo{display:flex;align-items:center;justify-content:space-between;height:32px;font-size:18px;font-weight:500}.card .mo div{display:flex;gap:4px}
...
.card .grid .h{height:24px;font-size:12px;color:var(--muted)}.card .grid .w{font-size:12px;color:var(--muted)}.card .grid .o{color:var(--muted)}.card .grid .t{background:rgba(var(--fg-rgb),.14);border-radius:16px;font-weight:500}
.card .now{display:flex;gap:16px;align-items:center}.card .now .tt{flex:1}.card .now .tr{margin-top:8px}.card .now .art{width:96px;height:96px;border-radius:12px;overflow:hidden;background:rgba(var(--fg-rgb),.06);display:flex;align-items:center;justify-content:center;color:var(--muted)}
...
.chip2{align-self:flex-start;height:28px;padding:0 12px;border-radius:14px;display:flex;align-items:center;font-size:12px;background:rgba(var(--attn-rgb),.14);color:var(--attn)}
.files{display:flex;gap:16px;min-height:200px}.files .sb{display:flex;flex-direction:column;gap:4px;width:120px}.files .sb div{height:32px;border-radius:16px;padding:0 12px;display:flex;align-items:center;gap:8px;font-size:13px}.files .sb div.on{background:rgba(var(--fg-rgb),.14)}
...
.picker .tabs{display:flex;gap:8px}.picker .tabs span{height:40px;padding:0 20px;border-radius:20px;display:flex;align-items:center;color:var(--muted)}.picker .tabs span.on{background:rgba(var(--fg-rgb),.14);color:var(--fg)}
.picker .shots{display:grid;grid-template-columns:1fr 1fr;gap:8px}.picker .shot{border-radius:12px;background:rgba(var(--fg-rgb),.06);padding:8px;display:flex;flex-direction:column;gap:8px;font-size:12px;color:var(--muted)}.picker .shot i{display:block;height:80px;border-radius:8px}
.picker .shot.on{background:rgba(var(--fg-rgb),.14);box-shadow:0 0 0 1px rgba(var(--fg-rgb),.24)}.picker .go{align-self:flex-end;height:40px;padding:0 20px;border-radius:20px;background:var(--fg);color:var(--raised);display:flex;align-items:center}
.lock{align-items:center;justify-content:center;gap:24px;min-height:240px;padding:24px}.lock .mark{font-size:40px;font-weight:500;letter-spacing:-.03em}.lock .in{width:240px;height:40px;border-radius:20px;background:rgba(var(--fg-rgb),.10);display:flex;align-items:center;gap:8px;padding:0 16px;box-shadow:0 0 0 1px rgba(var(--fg-rgb),.24)}.lock .in .dots{display:flex;gap:8px;flex:1;justify-content:center;margin-right:20px}.lock .in i{width:8px;height:8px;border-radius:4px;background:var(--fg)}
.pk .row2{display:flex;gap:12px;align-items:flex-start}.pk .ic{width:40px;height:40px;border-radius:20px;background:rgba(var(--fg-rgb),.06);display:flex;align-items:center;justify-content:center;flex:none}
.pk .tt b{font-size:18px;font-weight:500;display:block}.pk .tt span{color:var(--muted);line-height:1.5;display:block;margin-top:4px}
.pk .in{height:40px;border-radius:20px;background:rgba(var(--fg-rgb),.10);display:flex;align-items:center;padding:0 16px;gap:8px;box-shadow:0 0 0 1px rgba(var(--fg-rgb),.24)}.pk .in i{width:8px;height:8px;border-radius:4px;background:var(--fg)}
.pk .btns{display:flex;gap:8px;justify-content:flex-end}.pk .btns span{height:40px;padding:0 20px;border-radius:20px;display:flex;align-items:center;background:rgba(var(--fg-rgb),.06)}.pk .btns span.go{background:var(--fg);color:var(--raised)}
...
.pick .strip{display:flex;gap:8px}.pick .th{flex:1;border-radius:12px;padding:6px;background:rgba(var(--fg-rgb),.06)}.pick .th i{display:block;height:72px;border-radius:8px}.pick .th.on{background:rgba(var(--fg-rgb),.14);box-shadow:0 0 0 1px rgba(var(--fg-rgb),.24)}.pick .names{display:flex;gap:8px;font-size:12px;color:var(--muted)}.pick .names span{flex:1;text-align:center}.pick .names span.on{color:var(--fg)}
.term{font-family:'JetBrains Mono',monospace;font-size:13px;line-height:20px;white-space:pre;background:var(--bg);color:var(--fg)}.term .p{color:var(--accent)}.term .c{color:var(--muted)}.wx .hero .cap span,.wx .stats span,.wx .days span{color:var(--wx-muted)}.wx .stats b{color:var(--wx-ink)}
...
.field{height:40px;border-radius:20px;background:rgba(var(--fg-rgb),.10);display:flex;align-items:center;gap:8px;padding:0 16px;box-shadow:0 0 0 1px rgba(var(--fg-rgb),.24)}.field i{font-style:normal;color:var(--muted)}
.rows{display:flex;flex-direction:column;gap:8px}.row{height:40px;border-radius:20px;display:flex;align-items:center;gap:12px;padding:0 16px}.row .n{flex:1}.row .k{font-size:12px;color:var(--muted)}.row.sel{background:rgba(var(--fg-rgb),.14)}.row.hov{background:rgba(var(--fg-rgb),.10)}
...
.note .app{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--muted);line-height:1}.note .app .t{margin-left:auto}.note .title{font-size:18px;font-weight:500;margin-top:4px}.note .thumbs{display:flex;gap:8px;margin-top:8px}.note .thumbs span{width:56px;height:56px;border-radius:8px;overflow:hidden}.note .body{color:var(--muted)}
...
<div class="pills"><span class="l">Power profile</span><div><em>{ic("eco")}Saver</em><em class="on">{ic("balance")}Balanced</em><em>{ic("bolt")}Performance</em></div></div></div>''',
     "media": f'''<div class="card" style="width:352px;gap:16px"><div class="now"><div class="art" style="background:url('file://{t["walls"][1][1]}') 30% 40%/300% auto"></div><div class="tt"><b>The Visit</b><i>Agar Agar</i><div class="tr"><span class="b">{ic("prev",20)}</span><span class="play">{ic("pause",20)}</span><span class="b">{ic("next",20)}</span></div></div></div>
<div class="rail" style="gap:8px"><div class="hair"><i style="width:56%"></i></div><div class="lbl">2:22<span>-1:48</span></div></div></div>''',
     "mood": f'''<div class="card" style="width:352px;gap:16px"><div class="mood"><span style="background:url('file://{t["walls"][0][1]}') 10% 20%/260% auto"></span><span style="background:url('file://{t["walls"][1][1]}') 70% 30%/260% auto"></span><span style="background:url('file://{t["walls"][1][1]}') 20% 80%/260% auto"></span><span style="background:url('file://{t["walls"][0][1]}') 80% 70%/260% auto"></span></div><div class="hd" style="height:auto"><div>Backgrounds<div style="font-size:14px;color:var(--muted);font-weight:400;margin-top:4px">Graded to the ground</div></div><span>2 per tone</span></div></div>''',
     ...
     "files": f'''<div class="card" style="width:352px;gap:16px"><div class="hd" style="height:auto"><div style="display:flex;gap:8px;align-items:center">{ic("chevron_left",20)}{ic("chevron_right",20)}<span style="height:32px;padding:0 16px;border-radius:16px;background:rgba(var(--fg-rgb),.06);display:flex;align-items:center;gap:8px;font-size:14px;font-weight:400">{ic("home",16)}Home</span></div>{ic("search",20)}</div>
...
<div class="shots"><div class="shot on"><i style="background:url('file://{t["walls"][0][1]}') center/cover"></i>DP-1 · 3840 × 2160</div><div class="shot"><i style="background:url('file://{t["walls"][1][1]}') center/cover"></i>eDP-1 · 2880 × 1800</div></div><span class="go">Share</span></div>''',
...
<span class="p">❯</span> <span style="display:inline-block;width:8px;height:16px;background:var(--fg);vertical-align:-3px"></span></div></div>''',
     "menu": f'''<div class="launcher menu" style="width:352px"><div class="hd" style="height:32px;display:flex;align-items:center;justify-content:space-between;font-size:18px;font-weight:500">Omarchy<span style="font-size:12px;color:var(--muted);font-weight:400">SUPER + ALT + SPACE</span></div><div class="rows">
...
.win{{position:absolute;background:var(--bg);border-radius:24px;overflow:hidden;box-shadow:0 8px 40px rgba(0,0,0,var(--sh)),0 0 0 1px rgba(var(--fg-rgb),.10)}}
...
.bgtile{{display:flex;flex-direction:column;gap:12px}}.img{{width:704px;height:396px;border-radius:16px;box-shadow:0 12px 32px rgba(0,0,0,var(--sh))}}
