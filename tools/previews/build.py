...
def tone(root, light):
    ...
    return dict(light=light, bg=c["background"], raised=c["lighter_background"], ground=c["dark_background"], fg=c["foreground"], muted=c["muted"],
                ...
                pw=(pw["background"], pw["text"], pw["muted"], pw["attention-fill"], pw["attention-text"]))
...
.pw{background:var(--pw-bg);color:var(--pw-ink)}.pw .hd span{color:var(--pw-muted)}.pw .stats b{color:var(--pw-ink)}.pw .stats span,.pw .pills span.l{color:var(--pw-muted)}
...
.ring{position:relative;width:144px;height:144px;margin:0 auto}.ring b{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:48px;font-weight:500;letter-spacing:-.03em;font-variant-numeric:normal}
.tile{width:20px;height:20px;border-radius:6px;flex:none}.tile.lg{width:64px;height:64px;border-radius:8px}.wx .hero .cap span,.wx .stats span,.wx .days span{color:var(--wx-muted)}.wx .stats b{color:var(--wx-ink)}
...
<div class="row"><span class="tile" style="background:linear-gradient(135deg,#f24e1e 0 33%,#a259ff 33% 66%,#1abcfe 66%)"></span><span class="n">Figma</span><span class="k">Web app</span></div><div class="row"><span class="tile" style="background:#1a1a1a;border:1px solid rgba(var(--fg-rgb),.2)"></span><span class="n">Fastfetch</span><span class="k">Command</span></div><div class="row"><span class="tile" style="background:linear-gradient(135deg,#6b6b6b,#3a3a3a)"></span><span class="n">Font manager</span><span class="k">Application</span></div></div></div>''',
     "note": f'''<div class="note" style="width:360px"><div class="app"><span class="tile" style="background:linear-gradient(135deg,#3c8ff0,#1c4fb0)"></span>Thunderbird<span class="t">now</span></div><div class="title">Marvin Schwaibold</div><div class="body">Grid first, then a clean type scale. Art direct a few key widgets and the rest is propagation.</div><div class="hair acc" style="margin-top:8px"><i style="width:62%"></i></div></div>''',
...
<div class="mo">September 2026<div>{ic("chevron_left",20)}{ic("chevron_right",20)}</div></div><div class="grid">{g}</div></div>''',
     "power": f'''<div class="card pw" style="width:360px"><div class="hd">Battery<span class="chip">Charging · 1:05 to full</span></div>
<div class="ring"><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(0deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(6deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(12deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(18deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(24deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(30deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(36deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(42deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(48deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(54deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(60deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(66deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(72deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(78deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(84deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(90deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(96deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(102deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(108deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(114deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(120deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(126deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(132deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(138deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(144deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(150deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(156deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(162deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(168deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(174deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(180deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(186deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(192deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(198deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(204deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(210deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(216deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(222deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(228deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(234deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(240deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(246deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(252deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(258deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(264deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(270deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(276deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(282deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(288deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(294deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(300deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:var(--pw-ink);transform-origin:1px 72px;transform:rotate(306deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:rgba(var(--pw-rgb),.08);transform-origin:1px 72px;transform:rotate(312deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:rgba(var(--pw-rgb),.08);transform-origin:1px 72px;transform:rotate(318deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:rgba(var(--pw-rgb),.08);transform-origin:1px 72px;transform:rotate(324deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:rgba(var(--pw-rgb),.08);transform-origin:1px 72px;transform:rotate(330deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:rgba(var(--pw-rgb),.08);transform-origin:1px 72px;transform:rotate(336deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:rgba(var(--pw-rgb),.08);transform-origin:1px 72px;transform:rotate(342deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:rgba(var(--pw-rgb),.08);transform-origin:1px 72px;transform:rotate(348deg)"></span><span style="position:absolute;left:71px;top:0;width:2px;height:8px;border-radius:1px;background:rgba(var(--pw-rgb),.08);transform-origin:1px 72px;transform:rotate(354deg)"></span><b>87%</b></div>
...
<div class="pills"><span class="l">Power profile</span><div><em>{ic("eco")}Saver</em><em class="on">{ic("balance")}Balanced</em><em>{ic("bolt")}Performance</em></div></div></div>''',
     "media": f'''<div class="card" style="width:360px;gap:16px"><div class="now"><span class="tile lg" style="background:linear-gradient(135deg,#f6c1cf 0%,#f18aa0 45%,#7ba9e8 100%)"></span><div class="tt"><b>The Visit</b><i>Agar Agar</i><small>The Dog and the Future</small></div></div>
