...
def tone(root, light):
    ...
    return dict(light=light, bg=c["background"], raised=c["lighter_background"], ground=c["dark_background"], fg=c["foreground"], muted=c["muted"],
                ...
                wall=root / ("light/backgrounds" if light else "backgrounds") / "0-marvin.jpg",
                room=root / ("light/backgrounds" if light else "backgrounds") / "0-marvin.jpg",
...
<div class="row sel"><span class="n">Padding equals radius, so content sits at the centre of the corner arc.</span><span class="k">2m</span></div><div class="row"><span class="n">https://github.com/adamperlis/omarchy-marvin</span><span class="k">14m</span></div><div class="row"><span class="n">omarchy theme set marvin-light</span><span class="k">1h</span></div><div class="row"><span class="n">#7aa6ff</span><span class="k">3h</span></div></div></div>''',
     ...
     "toast": f'''<div class="toast" style="width:352px">{ic("check",20)}<div class="m">Theme set to Marvin<span>65 wallpapers</span></div><span class="bt sec" style="height:32px;padding:0 16px;border-radius:16px;font-size:13px">Undo</span></div>''',
...
<div class="tile" style="left:768px;top:56px;width:480px;height:250px"><div class="win">
...
<div class="tile" style="left:1272px;top:56px;width:480px;height:300px">{w["weather"]}</div>
<div class="tile" style="left:768px;top:330px;width:480px;height:360px">{w["clock"]}</div>
<div class="tile" style="left:768px;top:714px;width:480px;height:274px">{w["todos"]}</div>
<div class="tile" style="left:1272px;top:380px;width:480px;height:608px">{w["power"]}</div>
</body></html>"""
